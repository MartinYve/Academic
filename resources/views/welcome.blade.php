...
<section class="home-slider owl-carousel">
		<div class="slider-item" style="background-image:url(images/bg_1.jpg);">
			...
			<div class="col-md-8 text-center ftco-animate">
				<h1 class="mb-4">Bienvenu sur<span>Academia School</span></h1>
		...
		<section class="ftco-services ftco-no-pb">
			...
			<div class="col-md-3 d-flex services align-self-stretch pb-4 px-4 ftco-animate bg-primary">
				...
				<div class="media-body p-2 mt-3">
					...
					<p>Les professeurs enregistrés dans Academia sont tous diplomés de grandes universités et ont une grande expertise dans le domaine de l'enseignement.</p>
				</div>
				</div>      
			</div>
			<div class="col-md-3 d-flex services align-self-stretch pb-4 px-4 ftco-animate bg-tertiary">
				...
				<div class="media-body p-2 mt-3">
					...
					<p>Academia mets a la disposition des étudiants une mini bibliothèque constituée des cours dispensés par les enseignants du niveau 1 au niveau 5.</p>
				</div>
				</div>    
			</div>
			<div class="col-md-3 d-flex services align-self-stretch pb-4 px-4 ftco-animate bg-fifth">
				...
				<div class="media-body p-2 mt-3">
					...
					<p>Academia permet de rendre numérique le fonctionnement globale d'une université, a savoir : La gestion des cours/Devoir , le remplissage du cahier de texte etc....</p>
				</div>
				</div>      
			</div>
			<div class="col-md-3 d-flex services align-self-stretch pb-4 px-4 ftco-animate bg-quarternary">
				...
				<div class="media-body p-2 mt-3">
					...
					<p>Les étudiants inscris dans Academia sont tous des étudiants de l'ENSET de douala.</p>
				</div>
				</div>      
			</div>
			</div>
		...
		<section class="ftco-section ftco-no-pt ftc-no-pb">
			<div class="container">
				<div class="row">
	          	...
	          	<h2 class="mb-4">Bienvenu sur l'école d'apprentissage Academia School</h2>
          	...
          	<h2 class="mb-4">Ce que nous offrons</h2>
						<p>On her way she met a copy. The copy warned the Little Blind Text, that where it came from it would have been rewritten a thousand times and everything that was left from its origin would be the word.</p>
						<div class="row mt-5">
							<div class="col-lg-6">
							...
							<div class="col-lg-6">
								<div class="services-2 d-flex">
									...
									<div class="text">
										<h3>Les enseignants certifiés</h3>
										<p>Far far away, behind the word mountains, far from the countries Vokalia.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="services-2 d-flex">
									...
									<div class="text">
										<h3> Salles de classe suffisants</h3>
										<p>Far far away, behind the word mountains, far from the countries Vokalia.</p>
									</div>
								</div>
							</div>
		...
		<section class="ftco-intro" style="background-image: url(images/ac2.jpg);" data-stellar-background-ratio="0.5">
			<div class="overlay"></div>
			<div class="container">
				<div class="row">
					<div class="col-md-9">
						<h2>Etudiants du niveau 3 du département de génie informatique</h2>
						<p class="mb-0">Promotion amour.</p>
					</div>
			...
			<div class="container">
				<div class="row justify-content-center mb-5 pb-2">
					<div class="col-md-8 text-center heading-section ftco-animate">
						<h2 class="mb-4"><span>Enseignants</span> certifiés</h2>
						<p>Parmi eux, nous avons des produits de l'ENSET</p>
					</div>
				</div>	
				<div class="row">
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							...
							<div class="text pt-3 text-center">
								<h3>Pr NNEME NNEME Léandre</h3>
								<span class="position mb-2">Enseignant de didactique spéciale</span>
								<div class="faded">
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							...
							<div class="text pt-3 text-center">
								<h3>M. MANGA Igance </h3>
								<span class="position mb-2">Enseignant</span>
								<div class="faded">
									<p>Enseigne le cours de programmation en langage C au niveau 1; le cours de programmation logique au niveau 2. Etc...</p>
									<ul class="ftco-social text-center">
		                <li class="ftco-animate"><a href="#"><span class="icon-twitter"></span></a></li>
		                <li class="ftco-animate"><a href="#"><span class="icon-facebook"></span></a></li>
		                <li class="ftco-animate"><a href="#"><span class="icon-google-plus"></span></a></li>
